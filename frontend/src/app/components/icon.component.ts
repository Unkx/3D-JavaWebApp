...
export type IconName =
  | 'warning' | 'check-circle' | 'x-circle' | 'key' | 'trending-up' | 'coin'
  | 'star' | 'clipboard-list' | 'search' | 'inbox' | 'plus' | 'clipboard'
  | 'file' | 'image' | 'package' | 'zap' | 'folder' | 'check' | 'x'
  | 'arrow-left' | 'user';
...
@Component({
  ...
  template: `
    ...
    ></svg>
  `,
  host: { class: 'app-icon', style: 'display: inline-flex; line-height: 0;' },
})
